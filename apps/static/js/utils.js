window.pg = {
    namespace: {
        ...
        /**
         * 注册命名空间
         * @param {String} fullNS 完整的命名空间字符串，如mogu.libs.Firefox
         * @example baidu.namespace.register("mogu.libs.Firefox");
         */
        register: function (fullNS) {
            ...
            // 将命名空间切成N部分, 比如mogu.libs.Firefox等
 ...
 * @returns {*}
 */
String.prototype.lineToUpperCamelCase = function(){
